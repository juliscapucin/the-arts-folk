...
const STATIC_PATHS = ["/", "/news", "/project", "/artists", "/info"]

// Optional: map Sanity `_type` to your URL structure
...
export async function POST(req: NextRequest) {
	...
	try {
		...
		const staticRevalidations = STATIC_PATHS.map((path) => revalidatePath(path))
