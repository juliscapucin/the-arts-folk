...
export default function Header({ navLinks }: HeaderProps) {
	...
	return (
		<header
			className={`header fixed top-0 left-0 right-0 bg-primary pt-2 flex justify-between items-end h-[var(--header-height-mobile)] lg:h-[var(--header-height-desktop)] ${logoClass}`}>
